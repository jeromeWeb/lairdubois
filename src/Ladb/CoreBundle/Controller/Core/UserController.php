...
class UserController extends Controller
{
    ...
    public function showAction($username)
    {
        ...
        } elseif ($user->getMeta()->getPublicPlanCount() > 0) {
            $forwardController = 'LadbCoreBundle:Core/User:showPlans';
        } elseif ($user->getMeta()->getPublicHowtoCount() > 0) {
            $forwardController = 'LadbCoreBundle:Core/User:showHowtos';
        } elseif ($user->getMeta()->getPublicWorkshopCount() > 0) {
            $forwardController = 'LadbCoreBundle:Core/User:showWorkshops';
        } elseif ($user->getMeta()->getPublicFindCount() > 0) {
